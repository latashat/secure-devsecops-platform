...
Secure DevSecOps platformimplementing Terraform Iac, CI/CD automation, Okta-based zero-trust identity and containerized workloads on Amazon EKS with ECS alternative.
